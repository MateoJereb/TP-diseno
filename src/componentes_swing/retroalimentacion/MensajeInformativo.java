...
public class MensajeInformativo extends JDialog {
	...
	public MensajeInformativo(JFrame ventanaPadre, String textoMensaje, String textoBoton1, String textoBoton2) {
		
		super(ventanaPadre,"Aviso");
		...
		imagen = new ImageIcon("resources\\aviso.png"); 
		icono = new EtiquetaJ();
