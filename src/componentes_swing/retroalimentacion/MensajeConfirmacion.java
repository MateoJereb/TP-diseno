...
public class MensajeConfirmacion extends JDialog {
	...
	public MensajeConfirmacion(JFrame ventanaPadre, String textoMensaje, String textoBoton1, String textoBoton2) {
		super(ventanaPadre,"Confirmación");
		...
		imagen = new ImageIcon("resources\\confirmacion.png"); 
		icono = new EtiquetaJ();
